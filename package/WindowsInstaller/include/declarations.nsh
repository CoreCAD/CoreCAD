...
!define APP_SHORTCUT_INFO "${APP_NAME} - Focused Parametric Mechanical CAD Modeler"
!define APP_INFO "Install/Uninstall ${APP_NAME}"
!define APP_WEBPAGE "https://www.corecad.org/"
