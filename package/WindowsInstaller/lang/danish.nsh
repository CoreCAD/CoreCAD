...
${LangFileString} TEXT_WELCOME "Denne guide vil installere CoreCAD på din computer.$\r$\n\
				$\r$\n\
				$_CLICK"
...
${LangFileString} SecCoreDescription "Filerne til CoreCAD."
#${LangFileString} SecAllUsersDescription "Installer CoreCAD til alle brugere, eller kun den aktuelle bruger."
${LangFileString} SecFileAssocDescription "Opret association mellem CoreCAD og .FCStd filer."
...
#${LangFileString} ConfigInfo "Den følgende konfiguration af CoreCAD vil tage et stykke tid."
...
${LangFileString} AlreadyInstalled "CoreCAD ${APP_SERIES_KEY2} er allerede installeret!$\r$\n\
...
#${LangFileString} FinishPageMessage "Tillykke!! CoreCAD er installeret.$\r$\n\
#					$\r$\n\
#					(Når CoreCAD startes første gang, kan det tage noget tid.)"
${LangFileString} FinishPageRun "Start CoreCAD"

${LangFileString} UnNotInRegistryLabel "Kunne ikke finde CoreCAD i registreringsdatabsen.$\r$\n\
					Genvejene på skrivebordet og i Start-menuen bliver ikke fjernet"
${LangFileString} UnInstallRunning "Du ma afslutte CoreCAD forst!"
${LangFileString} UnNotAdminLabel "Du skal have administrator-rettigheder for at afinstallere CoreCAD!"
${LangFileString} UnReallyRemoveLabel "Er du sikker på, at du vil slette CoreCAD og alle tilhørende komponenter?"
...
${LangFileString} SecUnPreferencesDescription 'Sletter CoreCAD$\'s konfigurations mappe$\r$\n\
						$\"$AppPre\username\$\r$\n\
						$AppSuff\$\r$\n\
						${APP_DIR_USERDATA}$\")$\r$\n\
						for alle brugere.'
...
${LangFileString} SecUnProgramFilesDescription "Afinstallerer CoreCAD og alle dets komponenter."
