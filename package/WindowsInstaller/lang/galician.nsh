...
${LangFileString} TEXT_WELCOME "Este asistente vai-no guiar na instalación do CoreCAD no seu computador.$\r$\n\
				$\r$\n\
				$_CLICK"
...
#${LangFileString} SecAllUsersDescription "Instalar o CoreCAD monousuário ou multiusuário."
${LangFileString} SecFileAssocDescription "Asociar a extensión .FCStd co CoreCAD."
${LangFileString} SecDesktopDescription "Cria un icone do CoreCAD no ambiente de traballo."
...
#${LangFileString} ConfigInfo "A configuración seguinte do CoreCAD irá demorar un pouco."
...
${LangFileString} AlreadyInstalled "O CoreCAD ${APP_SERIES_KEY2} xa está instalado!$\r$\n\
...
#${LangFileString} FinishPageMessage "Parabéns! O CoreCAD foi instalado con suceso.$\r$\n\
#					$\r$\n\
#					(O primeiro início do CoreCAD pode levar alguns segundos.)"
${LangFileString} FinishPageRun "Lanzar o CoreCAD"

${LangFileString} UnNotInRegistryLabel "Non se da achado o CoreCAD no registo.$\r$\n\
					Non se eliminarán os atallos para o ambiente de traballo e no menu de Início."
${LangFileString} UnInstallRunning "Debe fechar o CoreCAD en primeiro lugar!"
${LangFileString} UnNotAdminLabel "Precisa de priviléxios de administrador para desinstalar o CoreCAD!"
${LangFileString} UnReallyRemoveLabel "Seguro que quer eliminar completamente o CoreCAD e todos os seus componentes?"
${LangFileString} UnFreeCADPreferencesTitle 'Preferéncias de usuário do CoreCAD'

#${LangFileString} SecUnProgDescription "Desinstala xxx."
${LangFileString} SecUnPreferencesDescription 'Elimina as pastas de configuración do  CoreCAD$\r$\n\
						$\"$AppPre\username\$\r$\n\
						$AppSuff\$\r$\n\
						${APP_DIR_USERDATA}$\")$\r$\n\
...
${LangFileString} SecUnProgramFilesDescription "Desinstala CoreCAD e todos os seus componentes."
